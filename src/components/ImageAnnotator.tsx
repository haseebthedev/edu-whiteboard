 ...
 * how this works.
 */
const ImageBoundsOverlay = track(function ImageBoundsOverlay({ imageShapeId }: { imageShapeId: TLShapeId }) {
...
function DoneButton({ imageShapeId, onClick }: { imageShapeId: TLShapeId; onClick(result: Blob): void }) {
  const editor = useEditor();
  return (
    <button
